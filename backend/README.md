...
## Project Structure
    ...
    ├── testapiautostoryboa_90939  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_90939`
...
2. Clone this repo and `cd testapiautostoryboa_90939`
